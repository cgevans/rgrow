"""Python facade for the SDC2DSquare model.
...
Rust `SDC2DSquare` re-exported from `rgrow.rgrow`.

`SDC2DSquare` exposes exact finite-grid thermodynamics methods including
...
from .rgrow import SDC2DSquare

__all__ = ["SDC2DStrand", "SDC2DParams", "SDC2DSquare"]
...
class SDC2DStrand:
    ...
    Lateral glue order matches kTAM: clockwise from north (N, E, S, W),
    followed by the scaffold-facing bottom glue.
    """
