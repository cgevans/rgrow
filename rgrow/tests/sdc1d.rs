...
fn strands() -> Vec<SDCStrand> {
    let strand = |base: String, input: usize| {
        SDCStrand {
            name: None,
            color: None,
            concentration: 1e6,
...
pub fn create_sequences_map() -> HashMap<RefOrPair, GsOrSeq> {
    HashMap::from([
        ...
        (RefOrPair::Ref("A".to_string()), GsOrSeq::Seq("TCTTTCCAGAGCCTAATTTGCCAG".to_string())),
        (RefOrPair::Ref("B".to_string()), GsOrSeq::Seq("AGCGTCCAATACTGCGGAATCGTC".to_string())),
        (RefOrPair::Ref("C".to_string()), GsOrSeq::Seq("ATAAATATTCATTGAATCCCCCTC".to_string())),
        (RefOrPair::Ref("D".to_string()), GsOrSeq::Seq("AAATGCTTTAAACAGTTCAGAAAA".to_string())),
        (RefOrPair::Ref("E".to_string()), GsOrSeq::Seq("AAAGAGGACAGATGAACGGTGTAC".to_string())),

        // Numbered sequences (0, 0', 1, 1', etc.)
        (RefOrPair::Ref("0".to_string()), GsOrSeq::Seq("CTCATCCTGACC".to_string())),
        (RefOrPair::Ref("0'".to_string()), GsOrSeq::Seq("CCTCTTCTCAGC".to_string())),
        (RefOrPair::Ref("1".to_string()), GsOrSeq::Seq("TCAACTCCGTTC".to_string())),
        (RefOrPair::Ref("1'".to_string()), GsOrSeq::Seq("CATCTCCGATCC".to_string())),
        (RefOrPair::Ref("2".to_string()), GsOrSeq::Seq("AATGCCACCATT".to_string())),
        (RefOrPair::Ref("2'".to_string()), GsOrSeq::Seq("TCTTTCCAAGCC".to_string())),
        (RefOrPair::Ref("3".to_string()), GsOrSeq::Seq("ACAACCCTTGTC".to_string())),
        (RefOrPair::Ref("3'".to_string()), GsOrSeq::Seq("TCAATCCTTGCC".to_string())),
        (RefOrPair::Ref("4".to_string()), GsOrSeq::Seq("CTGTTCCCAACA".to_string())),
        (RefOrPair::Ref("4'".to_string()), GsOrSeq::Seq("CACATCCCTGTT".to_string())),
        (RefOrPair::Ref("5".to_string()), GsOrSeq::Seq("CACTACCAGTCC".to_string())),
        (RefOrPair::Ref("5'".to_string()), GsOrSeq::Seq("CCATGTCCCATT".to_string())),
        (RefOrPair::Ref("6".to_string()), GsOrSeq::Seq("ACACACACTGTC".to_string())),
        (RefOrPair::Ref("6'".to_string()), GsOrSeq::Seq("CAACCAACGTTC".to_string())),
        (RefOrPair::Ref("7".to_string()), GsOrSeq::Seq("TCACTTTCGTCC".to_string())),
        (RefOrPair::Ref("7'".to_string()), GsOrSeq::Seq("TCACACTTCGTC".to_string())),
    ])
}

fn params() -> SDCParams {
    let scaffold =
        [None, None, Some("A*"), Some("B*"), Some("C*"), Some("D*"), Some("E*"), None, None]
